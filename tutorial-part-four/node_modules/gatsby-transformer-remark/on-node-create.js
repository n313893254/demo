...
module.exports = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(_ref) {
    ...
    var createNode, createParentChildLink, content, data, contentDigest, markdownNode, addParentToSubObjects;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            addParentToSubObjects = function addParentToSubObjects(data) {
              _.each(data, function (v, k) {
                if (_.isArray(v) && _.isObject(v[0])) {
                  _.each(v, function (o) {
                    return addParentToSubObjects(o);
                  });
